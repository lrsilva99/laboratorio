...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "appgeteway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "appgeteway API";

        private String description = "appgeteway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "appgeteway";
