(function() {
    ...
    Tbc_frasesDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Tbc_frases', 'Tbc_instituicao', 'Tbc_sub_grupo', 'Tbc_frases_opcoes'];

    function Tbc_frasesDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Tbc_frases, Tbc_instituicao, Tbc_sub_grupo, Tbc_frases_opcoes) {
        var vm = this;
        ...
        vm.tbc_frases_opcoes = Tbc_frases_opcoes.query();
